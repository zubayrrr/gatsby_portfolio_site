          ...
          <Container className="about-wrapper">
            ...
            <div className="row justify-content-center">
              <div className="col-lg-8">
                ...
                <br />
                <div>
                  I've built projects on ReactJs and GatsbyJs and also worked on
                  various other web technologies.
                </div>
                <br />
                <div>
                  AWS had always been my interest ever since I learned about
                  hosting content on the cloud, in 2019 I thought I should give
                  it a try so I went ahead and got certified as an AWS solutions
                  architect.
                </div>
              </div>
            </div>
